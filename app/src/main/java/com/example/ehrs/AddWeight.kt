...
import kotlinx.android.synthetic.main.input_mn_weight.*
...
class AddWeight   : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.input_mn_weight)


        update_mn_weight.setOnClickListener {

            val bodyweight: Float = input_value_weight.text.toString().toFloat()
...
//            editor.apply()
            ...
            jsonobjAddBP.put("weight_patient",bodyweight)
