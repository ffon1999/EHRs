...
import kotlinx.android.synthetic.main.log_history_glucose.*

class HistoryGlucose  : AppCompatActivity() {
    private val list = ArrayList<DataOther>()
    private var mChart: LineChart? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.log_history_glucose)
    ...
    private fun setData() {
        ...
        //val oo =      calldata()
        val url = "https://ehr-system-project.herokuapp.com/api/examination/graph/glucose/"
        ...
        val request = JsonArrayRequest(
            ...
            Response.Listener {
                ...
                if (mChart!!.data != null &&
                    ...
                    set1 = LineDataSet(values, "ระดับน้ำตาล")
                    ...
                    if (Utils.getSDKInt() >= 18) {
                        val drawable = ContextCompat.getDrawable(this, R.drawable.glucose_color_graph)
    ...
    fun callList(){
        val url = "https://ehr-system-project.herokuapp.com/api/examination/list/glucose/"
        val sharedPreferences = getSharedPreferences("User_Info", Context.MODE_PRIVATE)
        val username =sharedPreferences.getString("Username","Username")
        ...
        val request = JsonArrayRequest(
            ...
            Response.Listener {
                for(i in 0 until it.length()){
                    ...
                    val datahis = jsonObj.getString("glucose_patient")

                    val data = DataOther(date,time,datahis)
                    list.add(data)
                    //create adapter
                    history_glucose.setHasFixedSize(true)
                    history_glucose.layoutManager = LinearLayoutManager(this)
                    val adapter = RvAdapterOther(this,list)
                    history_glucose.adapter = adapter
