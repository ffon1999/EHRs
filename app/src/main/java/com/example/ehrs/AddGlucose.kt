...
import kotlinx.android.synthetic.main.input_mn_glucose.*
...
class AddGlucose  : AppCompatActivity() {
    val url = "https://ehr-system-project.herokuapp.com/api/examination"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.input_mn_glucose)


        update_mn_glucose.setOnClickListener {

            val glucose: Int = input_value_glucose.text.toString().toInt()
...
//            editor.apply()
            ...
            jsonobjAddBP.put("glucose_patient",glucose)
