...
import kotlinx.android.synthetic.main.log_history_height.*

class HistoryHeight : AppCompatActivity() {
    private val list = ArrayList<DataOther>()
    private var mChart: LineChart? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.log_history_height)
    ...
    private fun renderData() {
        ...
        ll1.textSize = 10f
        val ll2 = LimitLine(300f, "Minimum Limit")//set min line point
        ll2.lineWidth = 2f
    ...
    private fun setData() {
        ...
        //val oo =      calldata()
        val url = "https://ehr-system-project.herokuapp.com/api/examination/graph/height/"
        ...
        val request = JsonArrayRequest(
            ...
            Response.Listener {
                ...
                if (mChart!!.data != null &&
                    ...
                    set1 = LineDataSet(values, "ส่วนสูง")
                    ...
                    if (Utils.getSDKInt() >= 18) {
                        val drawable = ContextCompat.getDrawable(this, R.drawable.height_color_graph)
    ...
    fun callList(){
        val url = "https://ehr-system-project.herokuapp.com/api/examination/list/height/"
        val sharedPreferences = getSharedPreferences("User_Info", Context.MODE_PRIVATE)
        val username =sharedPreferences.getString("Username","Username")
        ...
        val request = JsonArrayRequest(
            ...
            Response.Listener {
                for(i in 0 until it.length()){
                    ...
                    val datahis = jsonObj.getString("height_patient")

                    val data = DataOther(date,time,datahis)
                    list.add(data)
                    //create adapter
                    history_value_height.setHasFixedSize(true)
                    history_value_height.layoutManager = LinearLayoutManager(this)
                    val adapter = RvAdapterOther(this,list)
                    history_value_height.adapter = adapter
