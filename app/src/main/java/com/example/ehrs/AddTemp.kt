...
import kotlinx.android.synthetic.main.input_mn_temp.*
...
class AddTemp  : AppCompatActivity() {
    val url = "https://ehr-system-project.herokuapp.com/api/examination"
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.input_mn_temp)


        update_mn_temp.setOnClickListener {

                val bodytemp: Float = input_value_temp.text.toString().toFloat()
...
//            editor.apply()
                ...
                jsonobjAddBP.put("body_temperature_patient",bodytemp)
