...
class HistoryWeight : AppCompatActivity() {
    ...
    private fun setData() {
        ...
        //val oo =      calldata()
        val url = "https://ehr-system-project.herokuapp.com/api/examination/graph/weight/"
        ...
        val request = JsonArrayRequest(
            ...
            Response.Listener {
                ...
                if (mChart!!.data != null &&
                    ...
                    set1 = LineDataSet(values, "น้ำหนัก")
                    ...
                    if (Utils.getSDKInt() >= 18) {
                        val drawable = ContextCompat.getDrawable(this, R.drawable.weight_color_graph)
